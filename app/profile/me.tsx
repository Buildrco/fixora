  ...
  return <SafeAreaView style={s.safe} edges={["top"]}>
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.content}>
      ...
      <Animated.View style={{ opacity: intro, transform: [{ translateY: intro.interpolate({ inputRange: [0, 1], outputRange: [24, 0] }) }] }}>
        ...
        <View style={s.tabBar}>{tabs.map(item => <Pressable key={item.label} onPress={() => setTab(item.label)} style={[s.tab, tab === item.label && s.tabActive]}><Ionicons name={item.icon as keyof typeof Ionicons.glyphMap} size={18} color={tab === item.label ? colors.ink : colors.muted} /><Text style={[s.tabText, tab === item.label && s.tabTextActive]}>{item.label}</Text></Pressable>)}</View>
...
const s = StyleSheet.create({
  safe: { flex: 1, backgroundColor: colors.card }, content: { paddingBottom: 45 }, header: { height: 54, paddingHorizontal: 18, flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: colors.card }, headerTitle: { color: colors.ink, fontSize: 18, fontWeight: "800" }, headerActions: { flexDirection: "row", gap: 19 }, cover: { height: 140, backgroundColor: "#d4dce1", overflow: "hidden" }, coverOrb: { width: 210, height: 210, borderRadius: 105, backgroundColor: "rgba(255,255,255,.23)", position: "absolute", right: -45, top: -90 }, identityBlock: { paddingHorizontal: 17, paddingBottom: 17, backgroundColor: colors.card }, avatarWrap: { width: 96, height: 96, borderRadius: 48, padding: 4, backgroundColor: colors.card, position: "absolute", top: -48, left: 17 }, avatar: { width: "100%", height: "100%", borderRadius: 45 }, avatarBadge: { position: "absolute", right: -1, bottom: 3, width: 24, height: 24, borderRadius: 12, backgroundColor: colors.blue, alignItems: "center", justifyContent: "center", borderWidth: 2, borderColor: colors.card }, nameRow: { flexDirection: "row", alignItems: "center", gap: 6, marginTop: 55 }, name: { color: colors.ink, fontSize: 23, fontWeight: "800", letterSpacing: -0.4 }, verified: { width: 19, height: 19, borderRadius: 10, backgroundColor: colors.blue, alignItems: "center", justifyContent: "center" }, handle: { color: colors.muted, fontSize: 15, marginTop: 4 }, bio: { color: colors.ink, fontSize: 16, lineHeight: 23, marginTop: 24, maxWidth: 370 }, infoLine: { flexDirection: "row", flexWrap: "wrap", gap: 14, marginTop: 11 }, infoRow: { flexDirection: "row", alignItems: "center", gap: 5, marginTop: 11 }, infoText: { color: colors.muted, fontSize: 14 }, linkText: { color: "#2b9cca" }, following: { flexDirection: "row", alignItems: "baseline", marginTop: 20 }, followNumber: { color: colors.ink, fontSize: 15, fontWeight: "800" }, followLabel: { color: colors.muted, fontSize: 14 }, actions: { flexDirection: "row", gap: 11, marginTop: 17 }, secondaryButton: { flex: 1, height: 47, borderRadius: 24, borderWidth: 1, borderColor: "#cbd0d3", alignItems: "center", justifyContent: "center" }, secondaryText: { color: colors.ink, fontSize: 17, fontWeight: "800" }, tabBar: { height: 58, borderTopWidth: 1, borderBottomWidth: 1, borderColor: colors.line, flexDirection: "row", backgroundColor: colors.card }, tab: { flex: 1, alignItems: "center", justifyContent: "center", gap: 3, borderBottomWidth: 3, borderBottomColor: "transparent" }, tabActive: { borderBottomColor: colors.blue }, tabText: { color: colors.muted, fontSize: 11, fontWeight: "700" }, tabTextActive: { color: colors.ink }, section: { paddingHorizontal: 17, marginTop: 14 }, compose: { minHeight: 57, paddingHorizontal: 11, backgroundColor: colors.soft, flexDirection: "row", alignItems: "center", gap: 9 }, composeAvatar: { width: 33, height: 33, borderRadius: 17 }, composeText: { flex: 1, color: colors.muted, fontSize: 13 }, composer: { padding: 12, borderBottomWidth: 1, borderColor: colors.line }, postInput: { minHeight: 74, color: colors.ink, fontSize: 14, textAlignVertical: "top" }, editorActions: { flexDirection: "row", justifyContent: "flex-end", alignItems: "center", gap: 15, marginTop: 10 }, cancel: { color: colors.muted, fontSize: 13, fontWeight: "700" }, publish: { paddingHorizontal: 15, paddingVertical: 9, backgroundColor: colors.ink, borderRadius: 17 }, publishText: { color: "#fff", fontSize: 12, fontWeight: "800" }, empty: { alignItems: "center", paddingVertical: 38, borderBottomWidth: 1, borderColor: colors.line }, emptyTitle: { color: colors.ink, fontSize: 17, fontWeight: "800", marginTop: 11 }, emptyCopy: { color: colors.muted, fontSize: 13, marginTop: 5, textAlign: "center" }, post: { paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: colors.line }, postHead: { flexDirection: "row", alignItems: "center", gap: 9 }, postAvatar: { width: 38, height: 38, borderRadius: 19 }, postName: { color: colors.ink, fontSize: 14, fontWeight: "800" }, postMeta: { color: colors.muted, fontSize: 11, marginTop: 3 }, postText: { color: colors.ink, fontSize: 15, lineHeight: 22, marginTop: 10 }, postActions: { flexDirection: "row", justifyContent: "space-between", marginTop: 14, paddingRight: 16 }, sectionHead: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }, sectionTitle: { color: colors.ink, fontSize: 17, fontWeight: "800" }, sectionCopy: { color: colors.muted, fontSize: 12, marginTop: 3 }, shopGrid: { flexDirection: "row", gap: 11 }, product: { flex: 1 }, productImage: { width: "100%", height: 134, borderRadius: 13 }, productTitle: { color: colors.ink, fontSize: 13, fontWeight: "800", marginTop: 8 }, productMeta: { color: colors.muted, fontSize: 11, marginTop: 4 }, price: { color: colors.blue, fontSize: 13, fontWeight: "800", marginTop: 6 }, listItem: { minHeight: 70, flexDirection: "row", alignItems: "center", gap: 11, borderBottomWidth: 1, borderColor: colors.line }, listIcon: { width: 41, height: 41, backgroundColor: "rgba(45,127,249,.1)", alignItems: "center", justifyContent: "center" }, productImage: { width: "100%", height: 134, borderRadius: 13 },
});
