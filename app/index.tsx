...
export default function Home(){
 ...
 return <SafeAreaProvider><SafeAreaView edges={["top"]} style={styles.safe}><ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
  ...
  <View style={styles.popularSection}><SectionTitle title="Popular phones" action="Shop"/>
