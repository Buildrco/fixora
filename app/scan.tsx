...
export default function BoxScan() {
  ...
  return <SafeAreaView edges={["top", "bottom"]} style={styles.safe}>
    <View style={styles.content}>
      <View style={styles.header}><IconButton name="chevron-back" onPress={() => router.back()} /><View style={styles.headerTitle}><Text style={styles.kicker}>FIXORA DELIVERY</Text><Text style={styles.title}>Box scan</Text></View><View style={styles.headerSpacer} /></View>
